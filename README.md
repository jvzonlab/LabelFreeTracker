...
Then, run the script again. You will then get a new AUT file. In this AUT file the positions won't be linked already, but it will contain the scores for doing so.
